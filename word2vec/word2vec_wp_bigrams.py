...
# See https://radimrehurek.com/gensim/models/phrases.html#module-gensim.models.phrases
# finds often occurring bigrams
bigram_transformed = Phrases(sentences)
# replaces the bigrams by a single token in the learning proces
model = word2vec.Word2Vec(bigram_transformed[sentences], workers=num_workers, \
